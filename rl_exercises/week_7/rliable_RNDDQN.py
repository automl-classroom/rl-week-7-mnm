...
df_s0 = pd.read_csv("training_data_seed_0_RNDDQN.csv")
df_s1 = pd.read_csv("training_data_seed_1_RNDDQN.csv")
df_s2 = pd.read_csv("training_data_seed_2_RNDDQN.csv")
df_s3 = pd.read_csv("training_data_seed_3_RNDDQN.csv")
...
train_scores = {"rnd dqn": df["rewards"].to_numpy().reshape((n_seeds, -1))}
